    ...
    <div>
      ...
      <h3 style="font-family:'Bebas Neue', cursive; color: black; position: relative;">User Profile</h3>
        <b-container fluid>
          ...
          <b-row class="my-1">
            <label class="lname" for="input-small" style="font-family:'Bebas Neue', cursive;">Last Name</label>
            <b-col>
       ...
       <b-card class="card" bg-variant="light" style="display: inline-block; max-height:50rem; width: 1000px; border-radius: 20px; margin-top:20px;">
