...
class InkindDonationOrganizationRepository {
  /**
   *
  ...
  async list (filters = {}, options = {}) {
    ...
    const { data } = await this.apiClient.get(`/inkind-donation-organizations?${queryString.toString()}`)
...
module.exports = InkindDonationOrganizationRepository
