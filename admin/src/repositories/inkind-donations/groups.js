...
class InkindDonationGroupRepository {
  /**
   *
  ...
  async list (filters = {}, options = {}) {
    ...
    const { data } = await this.apiClient.get(`/inkind-donation-groups?${queryString.toString()}`)
...
module.exports = InkindDonationGroupRepository
